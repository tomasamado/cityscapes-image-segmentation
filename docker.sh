CONTAINER_NAME=tomasamado_docker
PROJECT_DIRECTORY_HOST=/raid/tomasamadopeters/simple-imageseg
PROJECT_DIRECTORY_CONTAINER=/project
DOCKER_IMAGE=nvcr.io/nvidia/pytorch:20.07-py3
JUPYTER_DOCKER_PORT=25345 # forward the jupyter port to this port on the host machine
JUPYTER_PORT=8888
